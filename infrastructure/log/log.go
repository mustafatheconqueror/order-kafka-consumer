...
type Logger interface {
	...
	WarnWithExtra(ctx context.Context, message string, dictionary map[string]interface{})
}
...
func (l *logger) WarnWithExtra(ctx context.Context, message string, dictionary map[string]interface{}) {
