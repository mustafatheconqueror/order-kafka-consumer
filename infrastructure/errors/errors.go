...
func NewWithStatusCode(definition ErrorDef, statusCode int, params ...interface{}) Error {
	return &errorImpl{definition: definition, statusCode: statusCode, params: params}
}
